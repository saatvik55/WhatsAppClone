...
import com.compose.whatsapp_clone.ui.components.StatusItem
import com.compose.whatsapp_clone.ui.data.StatusList
...
fun StatusTabContent() {
    Column(
        ...
        Text(
            text = stringResource(id = com.compose.whatsapp_clone.R.string.recent_updates),
            color = Color.Gray,
            fontSize = 15.sp,
